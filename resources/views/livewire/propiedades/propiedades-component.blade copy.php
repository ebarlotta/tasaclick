    ...
    <div class="modal fade" id="modal-default" style="display: none;" aria-hidden="true">
        ...
        <button type="button" class="btn btn-primary">Save changes</button>
                ...
                <form>
                    <div class="card-body">
                        <div class="info-box">
                            <span class="info-box-icon bg-success btn btn-default" wire:click="openclose1()"><i class="far fa-copy"></i></span>
                        ...
                        <div class="info-box">
                            <span class="info-box-icon bg-success btn btn-default" wire:click="openclose2()"><i class="far fa-copy"></i></span>
                            {{-- <span class="info-box-icon bg-success btn btn-default" data-toggle="modal" data-target="#propiedad2"><i class="far fa-copy"></i></span> --}}
        ...
        @if ($isModal1Open)
            @include('livewire.propiedades.propiedadesmodal1')
        @endif


        @if ($isModal2Open)
            @include('livewire.propiedades.propiedadesmodal2')
        @endif
