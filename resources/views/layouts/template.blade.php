    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="#!">Tasaclick</a>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            ...
                            <!--ACA ME QUEDE PERDIDO WEY-->
                                <a href="{{ url('/login')}}" class="btn btn-outline-light btn-lg px-4" >Iniciar sesion</a>

                                    
                                        <a href="{{ url('/register') }}" class="btn btn-primary btn-lg px-4 me-sm-3" href="#features">Registrarse</a>
