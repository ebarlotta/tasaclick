    ...
    <script>
        ...
        // Request needed libraries.
            ...
            const map = new Map(document.getElementById("map"), {
                center: { lat: -33.0829693, lng: -68.4651057 },
                zoom: 10,
                mapId: "4504f8b37365c3d0",
            });

            const parser = new DOMParser();
            // A marker with a custom inline Image.
            ...
            const pinSvgString ='<img width="56" height="56" src="/images/assets/sinimagen.jpg">';
            ...
            const pinSvgMarkerView = new AdvancedMarkerElement({
                map,
                position: { lat: -33.0829693, lng: -68.4651057 },
                content: pinSvg,
        ...
        //   beachFlagImg.src = "/images/assets/sinimagen.jpg";

        //   const beachFlagMarkerView = new AdvancedMarkerElement({
        //     map,
        //     position: { lat: -33.0829693, lng: -68.5651057 },
        ...
        const faMarker = new AdvancedMarkerElement({
            map,
            position: { lat: -33.0829693, lng: -68.351057 },
